...
export const Marketplace: React.FC<MarketplaceProps> = ({ 
  ...
  return (
    <div className="min-h-screen pb-20 relative">
      ...
      <div 
        ref={filterRef}
        className="sticky top-16 z-40 bg-white/95 dark:bg-slate-950/95 backdrop-blur-md border-b border-gray-200 dark:border-white/10 shadow-sm transition-all duration-300"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center gap-4 overflow-x-auto no-scrollbar">
          ...
          <div className="flex items-center flex-shrink-0">
              {/* Premium Sliding Toggle - Slow & Smooth */}
              <div 
      ...
      {/* Mobile Sell FAB - Smaller & Elegant */}
      <a
        href="?page=listing"
        onClick={(e) => {
           e.stopPropagation();
      ...
      {/* Fixed Position Dropdowns - Content */}
            ...
            <div className="p-5 w-72 bg-white dark:bg-slate-900 overflow-hidden">
              <div className="mb-6">
                ...
                <div className="relative h-8 flex items-center justify-center group select-none">
                    ...
                    {hoverPrice !== null && (
                        <div 
                            className="absolute -top-9 -translate-x-1/2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-[10px] font-bold px-2.5 py-1 rounded-lg shadow-xl pointer-events-none transition-none z-30 whitespace-nowrap"
