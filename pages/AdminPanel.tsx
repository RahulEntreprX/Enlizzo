...
export const AdminPanel: React.FC<AdminPanelProps> = ({ isDemo }) => {
  ...
  const loadReports = async () => {
    try {
        const data = await fetchReports(isDemo);
        setReports(data);
    } catch (e) {
        console.error(e);
    } finally {
      ...
      <div className="glass-panel rounded-2xl overflow-hidden">
         ...
         {loading ? (
             ...
             <div className="p-12 text-center">
                 <div className="inline-flex justify-center items-center p-4 rounded-full bg-emerald-100 dark:bg-emerald-900/20 text-emerald-600 mb-4">
                    <Check size={32} />
                 </div>
