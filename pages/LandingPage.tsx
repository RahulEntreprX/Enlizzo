...
export const LandingPage: React.FC<LandingPageProps> = ({ onLogin }) => {
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden transition-colors duration-300 bg-transparent">
      ...
      <div className="relative z-10 flex-grow flex flex-col">
        ...
        <section className="relative pt-32 pb-32 md:pt-48 md:pb-48 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 flex flex-col items-center">
            ...
            <div className="relative inline-flex flex-col items-center mt-6 mb-2 animate-slide-up">
               ...
               <h1 className="text-5xl md:text-7xl font-extrabold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 dark:from-cyan-400 dark:via-indigo-400 dark:to-purple-500 z-10 mt-4">
                 ENLIZZO
               </h1>
        ...
        {/* === SECTION 2: PROCESS === */}
        <section className="py-24 relative border-y border-gray-200 dark:border-white/5 bg-white/50 dark:bg-black/20 backdrop-blur-sm transition-colors duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
              {[
                ...
                <div key={idx} className="relative group">
                  ...
                  <div className="tech-border p-8 rounded-sm corner-accent hover:bg-white/50 dark:hover:bg-white/5 transition-all duration-500 h-full bg-white/50 dark:bg-gray-950/50">
        ...
        <section className="py-32 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-2 gap-6 h-auto md:h-[600px]">
              ...
              <div className="md:col-span-2 md:row-span-2 tech-border rounded-xl p-8 relative overflow-hidden group corner-accent bg-white/50 dark:bg-gray-950/50">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <span className="text-xs font-mono text-green-600 dark:text-green-500 uppercase">Live Activity</span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 max-w-md">
                    <div className="bg-white/60 dark:bg-black/40 p-4 border border-gray-200 dark:border-white/10 rounded">
              ...
              <div className="tech-border rounded-xl p-6 corner-accent flex flex-col justify-between group bg-white/50 dark:bg-gray-950/50">
                 <div>
        ...
        <section className="py-32 relative border-t border-gray-200 dark:border-white/5 overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto px-4 relative z-10">
            <div className="portal-card rounded-2xl p-1 shadow-[0_0_50px_rgba(99,102,241,0.1)] dark:shadow-[0_0_50px_rgba(79,70,229,0.15)]">
               <div className="bg-white/90 dark:bg-gray-950/80 rounded-xl p-12 md:p-16 text-center relative overflow-hidden">
